...
<body>
	...
	<div class="container" id="container">
		...
		<div class="search_box mar_to10">
			<form id="frm" action="./productList" method="GET"  >
				<div class="inner alC">
					...
					</select> <select name="airlineTypeSelect" style="width: 200px"
						id="airline_list">
					...
					<button type="submit" id="btn_search mp" class="btn_M red">조회하기</button>
				</div>
			</form>
		</div>
