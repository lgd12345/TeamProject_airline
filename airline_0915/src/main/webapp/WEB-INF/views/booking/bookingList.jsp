...
<body>
	...
	<div id="top">
		<div id="topWrap">
			<div id="top1">
				<i class="fa fa-plane"
					style="font-size: 23px; color: white; padding-top: 27px;"></i><br>
				<div style="padding-top: 20px; font-size: 20px;">
					${bookingVO.depLoc} <i class='fas fa-angle-right'
						style='font-size: 10px;'></i> ${bookingVO.arrLoc}
				</div>
			...
			<div id="top2">
				<i class="fa fa-plane"
					style="font-size: 23px; color: white; padding-top: 27px;"></i><br>
				<div style="padding-top: 20px; font-size: 20px;">
					${bookingVO.arrLoc} <i class='fas fa-angle-right'
						style='font-size: 10px;'></i> ${bookingVO.depLoc}
				</div>
			</div>

			<div id="top3">
				<i class="material-icons"
					style="font-size: 31px; color: white; padding-top: 20px;">person</i>
				<div style="padding-top: 14px; font-size: 18px;">
					성인 : ${bookingVO.adult}명<br> 아동 : ${bookingVO.child}명
				</div>
			</div>
	...
	<div id="noti">
		<div id="notiWrap">
			<table>
				<tr>
					<td class="tnoti" style="padding-bottom: 6px;">항공권 운임은 잔여 좌석에
						따라 실시간으로 달라질 수 있습니다.이후 예약상황 및 가격정책의 변경 등으로 인해 스케줄 및 운임의 변동이 있을 수
						있습니다.</td>
				</tr>
				<tr>
					<td class="tnoti"><span style="color: #f44336;">${today}</span>기준,
						유류할증료와 세금 및 제반요금 포함된 성인 1명 기준 운임입니다.</td>
				</tr>
			</table>
		</div>
	</div>
	...
	<section>
					...
					<table id="depT">
						...
						<c:forEach items="${DairList}" var="dlist">
							<tr class="dtrcheck">
									...
									<div class="timeIWrap">
										...
										<div style="float: left;">
											...
											<div>
												<div class="timmLeft">
													<i class="material-icons"
														style="padding-right: 10px; padding-left: 10px; color: #d60815;">flight_takeoff</i>
												</div>

												<div class="timmMid">
													<div class="timmM1">
														<i class='far fa-clock'></i> ${dlist.flightTime}분
													</div>
												...
												<div class="timmRight">
													<i class="material-icons"
														style="padding-left: 10px; padding-right: 10px; color: #d60815;">flight_land</i>
												</div>
											</div>
								...
								<td class="td2">
									<div
										style="float: left; padding-left: 30px; line-height: 73px;">
										<c:if test="${dlist.airlineNm == '대한 항공'}">
											<img alt="" src="../images/airline/1.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '아시아나항공'}">
											<img alt="" src="../images/airline/2.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '에어부산'}">
											<img alt="" src="../images/airline/3.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '에어서울'}">
											<img alt="" src="../images/airline/4.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '이스타항공'}">
											<img alt="" src="../images/airline/5.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '제주항공'}">
											<img alt="" src="../images/airline/6.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '진 에어'}">
											<img alt="" src="../images/airline/7.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '코리아 익스프레스 에어'}">
											<img alt="" src="../images/airline/8.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '티웨이항공'}">
											<img alt="" src="../images/airline/9.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '플라이 강원'}">
											<img alt="" src="../images/airline/10.png"
												style="width: 115px;">
										</c:if>
										<c:if test="${dlist.airlineNm == '하이에어'}">
											<img alt="" src="../images/airline/11.png"
												style="width: 115px;">
										</c:if>

									</div>
									<div
										style="float: left; padding-left: 25px; line-height: 73px;">${dlist.airlineNm}</div>
								</td>
								<td class="td1">${dlist.vihicleId}<input type="hidden"
									value="${dlist.fnum}" class="dfnum"></td>
							...
							<tr class="dhide">
								<td colspan="7" style="vertical-align: middle;">
									...
									<div
										style="width: 770px; margin: 0 auto; font-weight: bold; padding-left: 26px;">

										<div
											style="float: left; line-height: 34px; margin-right: 40px;">
											<div style="clear: both;">
												<div style="float: left;">출발시간 :&nbsp</div>
												<div class="deptd" style="float: left;">${dlist.depPlandTime}</div>
											</div>
										</div>

										<div
											style="float: left; line-height: 34px; margin-right: 37px;">
											<div style="clear: both;">
												<div style="float: left;">도착시간 :&nbsp</div>
												<div class="arrtd" style="float: left;">${dlist.arrPlandTime}</div>
											</div>
										</div>

										<div style="float: left; line-height: 34px;">
											<div style="clear: both;">
												<div style="float: left;">이동거리 :&nbsp</div>
												<div class="km" style="float: left;">${dlist.flightKm}KM</div>
											</div>
										</div>
									</div>
							...
							<c:forEach items="${AairList}" var="alist">
								<tr class="atrcheck">
										...
										<div class="timeIWrap">
											...
											<div style="float: left;">
												...
												<div>
													...
													<div class="timmMid">
														<div class="timmM1">
															<i class='far fa-clock'></i> ${alist.flightTime}분
														</div>
														<div class="timmM2">직항</div>
													</div>
									...
									<td class="td2">
										...
										<div
											style="float: left; padding-left: 25px; line-height: 73px;">${alist.airlineNm}</div>

									</td>
									<td class="td1">${alist.vihicleId}<input type="hidden"
										value="${alist.fnum}" class="afnum"></td>
									...
									<td colspan="7" style="vertical-align: middle;">
										...
										<div
											...
											<div
												...
												<div style="clear: both;">
													<div style="float: left;">출발시간 :&nbsp</div>
													<div class="deptd" style="float: left;">${alist.depPlandTime}</div>
												</div>
											</div>
											...
											<div
												...
												<div style="clear: both;">
													<div style="float: left;">도착시간 :&nbsp</div>
													<div class="arrtd" style="float: left;">${alist.arrPlandTime}</div>
												</div>
											</div>
											...
											<div style="float: left; line-height: 34px;">
												<div style="clear: both;">
													<div style="float: left;">이동거리 :&nbsp</div>
													<div class="km" style="float: left;">${alist.flightKm}KM</div>
												</div>
											</div>
										</div>
		...
		<form
			action="${pageContext.request.contextPath}/booking/bookingWritePre"
			method="post" id="frm">
		...
		<div class="gray_box" id="rev_dom_notice">
			<h5>유의사항</h5>
			<ul class="list_type2">
				<li><span style="color: #f44336;">${today}</span> (한국시간) 기준,
					유류할증료와 세금 및 제반요금 포함된 성인 1인 운임이며, 운임은 수시로 변경될 수 있습니다.</li>
	...
	<script type="text/javascript">
		...
		depSelectDate = depSelectDate.replace('년', '').replace('월', '')
				.replace('일', '').replace(' ', '').trim();
							...
							$
									.ajax({
										...
										success : function(data) {
											...
											var depdate1 = $('.bact').find(
													'.d1').text().replace('년',
													'').trim();
											var depdate2 = $('.bact').find(
													'.d2').text().replace('월',
													'').replace('일', '')
													.replace(' ', '').trim();
											var deptime = $('.act').find(
													'.tiRight').text().replace(
													':', '');

											var depM = depdate1 + depdate2
													+ deptime;

											var arrdate1 = $('.bact').find(
													'.d11').text().replace('년',
													'').trim();
											var arrdate2 = $('.bact').find(
													'.d12').text().replace('월',
													'').replace('일', '')
													.replace(' ', '').trim();
		...
		$('body').on(
				...
				function() {
					...
					if (n == -1) {
						...
						var dnew = ddy + '년 ' + ddm + '월 ' + ddd + '일 ' + ddh
								+ '시 ' + ddmi + '분 ';
						$(this).next('.dhide').find('.deptd').text(dnew);
						var arrtd = $(this).next('.dhide').find('.arrtd')
								.text();
						...
						var anew = ady + '년 ' + adm + '월 ' + add + '일 ' + adh
								+ '시 ' + admi + '분 ';
					...
					var depdate1 = $(this).closest('#depW').siblings(
							'#dateLine').find('.bact').find('.d1').text()
							.replace('년', '').trim();
					var depdate2 = $(this).closest('#depW').siblings(
							'#dateLine').find('.bact').find('.d2').text()
					...
					var arrdate1 = $(this).closest('#dep').siblings('#arr')
							.find('#arrW').siblings('#dateLine').find('.bact')
							.find('.d11').text().replace('년', '').trim();
					var arrdate2 = $(this).closest('#dep').siblings('#arr')
							.find('#arrW').siblings('#dateLine').find('.bact')
							.find('.d12').text().replace('월', '').replace('일',
									'').replace(' ', '').trim();

					var arrM = arrdate1 + arrdate2;

					$('#arrT').find('.atrcheck').each(
							function() {
								$(this).find('td').removeClass('block');
								$(this).find('td').find('.material-icons').css(
										'color', '#d60815');
								$(this).find('td').find('img').removeClass(
										'grayt');

								var arrtime = $(this).find('.tiLeft').text()
										.replace(':', '').trim();
								...
								if (Number(depM) > Number(atotal)) {
									...
									$(this).find('td').find('i').css('color',
											'#e4dbdb');
									$(this).find('td').find('img').addClass(
											'grayt');
		...
		$('body')
				.on(
						...
						function() {
							...
							var deptd = $(this).next('.ahide').find('.deptd')
									.text();
							var n = deptd.indexOf("년");
							if (n == -1) {
								var ddy = deptd.substring(0, 4);
								...
								var ddh = deptd.substring(8, 10);
								var ddmi = deptd.substring(10);
								var dnew = ddy + '년 ' + ddm + '월 ' + ddd + '일 '
										+ ddh + '시 ' + ddmi + '분 ';
								$(this).next('.ahide').find('.deptd')
										.text(dnew);

								var arrtd = $(this).next('.ahide').find(
										'.arrtd').text();
								var ady = arrtd.substring(0, 4);
								var adm = arrtd.substring(4, 6);
								var add = arrtd.substring(6, 8);
								var adh = arrtd.substring(8, 10);
								var admi = arrtd.substring(10);
								var anew = ady + '년 ' + adm + '월 ' + add + '일 '
										+ adh + '시 ' + admi + '분 ';
								$(this).next('.ahide').find('.arrtd')
										.text(anew);
