			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">EveryAir</h1>
					</div>
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-m font-weight-bold text-danger text-uppercase mb-1">이달의
												항공권 판매량 (2020/02)</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">
												<fmt:setLocale value="ko_KR" />
												<fmt:formatNumber type="currency" value="${mprice}"
													currencySymbol="￦" />
											</div>
										</div>
										<div class="col-auto">
							...
							<div class="card border-left-success shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-m font-weight-bold text-success text-uppercase mb-1">오늘의
												항공권 판매량 (2020/02/17)</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">
												<fmt:setLocale value="ko_KR" />
												<fmt:formatNumber type="currency" value="${tprice}"
													currencySymbol="￦" />
											</div>
										</div>
										<div class="col-auto">
							...
							<div class="card border-left-info shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-m font-weight-bold text-info text-uppercase mb-1">오늘의
												예매율</div>
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
												...
												<div class="col">
													<div class="progress progress-sm mr-2">
														<div class="progress-bar bg-info" role="progressbar"
															style="width: ${trate}%" aria-valuenow="${trate}"
							...
							<div class="card border-left-warning shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-m font-weight-bold text-warning text-uppercase mb-1">오늘의
												항공편</div>
