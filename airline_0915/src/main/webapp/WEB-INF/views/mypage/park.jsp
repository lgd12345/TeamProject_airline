...
<link rel="stylesheet" type="text/css"
	href="../resources/css/xddatepicker/jquery.datetimepicker.css">
		...
		<div id="hbh">
			...
			<div id="hbselect">
				<select onchange="location.href=this.value">
					...
					<option selected="selected" value="./notice22List">이용후기</option>
				</select>
			</div>
		</div>
	</div>
			...
			<div class="search_form">
				<div class="fbox">
					<div class="col01">
						...
						<div class="cal_wrap">
							<input type="text" id="resveBeginDt" name="startDate"
								value="${VO.startDate}" readonly="readonly">
						</div>
						<span class="bar">-</span>
						<div class="cal_wrap">
							<input type="text" id="resveEndDt" name="endDate"
				...
				<tbody>
					<c:forEach items="${list}" var="dto">
						<tr>
							...
							<td><button class="btn small wine"
									onclick="location.href='parkSelect?pResNum=${dto.pResNum}'">상세정보</button>
								<button class="btn small border"
									onclick="deleteconfirm(${dto.pResNum})">예약취소</button></td>
