...
<form action="${board2}Write1" method="post" enctype="multipart/form-data" id = "frm">
	...
	<tr>
		...
		<td>
			<select id="cate" name="cate" class=" cate common textWrite">
				...
				<option value="공항" disabled>공항</option>
				<option value="비행기" disabled>비행기</option>	
				<option value="여행" disabled>여행</option>
			...
			<td>
				<div class="jfile_wrap">
					...
					<ul class= "list_type">
						...
						<li>
							ㆍ JPG, JPEG, PNG, 파일 형태로 첨부하시기 바랍니다.
						</li>
						<li>
