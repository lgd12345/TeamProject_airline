	...
	<div class="container" id="container">
		<div class="mem_wrap">
			<div class="indicator_wrap">
				<ul>
					<li><span class="hidden">1. 회원 약관동의(현재 단계)</span></li>
					<li><span class="hidden">2. 회원 정보 입력</span></li>
					<li class="on"><span class="hidden">3. 가입완료</span></li>
				</ul>
			</div>
			...
			<div class="mem_end_wrap">
				<div class="left">
					<p class="fsz_23 title">
						<span class="col_brown2" id="memName">${memberVO.name}</span> 회원님,
						가입을 축하드립니다.
					</p>
					...
					<table class="table_list">
						<caption>
							...
							<p>회원번호,회원등급,이메일,아이디 로 구성된 표입니다.</p>
						</caption>
						<colgroup>
				...
				<div class="right">
					<div class="mem_barcode_wrap">
						...
						<div class="mem_barcode_info">
							<p class="mem_barcode qrcode" id="qrcode" style="padding: 0px 40px;"></p>
							<p class="mem_name">${memberVO.name}</p>
							<p class="mem_num">
								<span>${memberVO.memberNum}</span>
							</p>
						</div>
			...
			<div class="btn_wrap_ceType1">
				<button type="button" class="btn_L white" id="btn_main"
					onclick="location.href='../'">에브리에어 메인</button>
				<button type="button" class="btn_L red" id="btn_login"
					onclick="location.href='./memberLogin'">로그인</button>
			</div>
					...
					<li>
						...
						<div class="txt_wrap">
							<dl>
								<dt>마일리지 적립 및 사용</dt>
								<dd>
									에브리에어클럽은 에브리에어의 사용우대 프로그램으로 '에브리에어클럽 마일리지'를 기반으로 운영됩니다. <br>에브리에어클럽
									회원님께서는 아시아나 항공 및 제휴사를 이용하실 때마다 마일리지를 적립하실 수 있으며 적립된 마일리지로 마일리지
									항공권 이용 <br>등이 가능하십니다.
								</dd>
							</dl>
						</div>
							...
							<li>
								...
								<div class="txt_wrap">
									<dl>
										<dt>에브리에어항공 뉴스레터</dt>
										<dd>
											뉴스레터를 통해, 마일리지 실적 및 에브리에어의 <br>다양한 혜택을 이메일로 받아 보실 수
											있습니다.
										</dd>
									</dl>
								</div>
							...
							<li>
								...
								<div class="txt_wrap">
									<dl>
										<dt>회원전용 이벤트 참여하기</dt>
										<dd>
											에브리에어 웹사이트에서 진행하는 다양한 이벤트에 <br>참여하실 수 있습니다.
										</dd>
									</dl>
								</div>
							</li>
